...
import { cssDisplayNone, cssTransparent } from '../../components/common/StyleUtilCSS';
...
const CustomTable = (props) => {
    const {subjects, type, data, pagingObjects} = props;        
    ...
    return (
        <TableWrapper> 
            ...
            <PagingWrapper>
                {pagingObjects.length > 0 && pagingObjects.map((v, i) => {
                    return <PagingItem key = {i}>{v.pagenum}</PagingItem>;
                })}
            </PagingWrapper>
